...
class TinBaoChi extends ComponentBase
{
    public $posts;
    ...
    public function componentDetails()
    {
        return [
            'name'        => 'Tin Bao Chi',
            'description' => 'Danh sách tin báo chí'
        ];
    }
    ...
    public function onRun()
    {
        ...
        // $this->firstPosts = $this->page['firstPosts'] = $this->posts->where('hot_news',1);
